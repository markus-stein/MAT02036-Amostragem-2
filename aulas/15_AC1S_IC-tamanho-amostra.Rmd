...
* O coeficiente de variação $CV$, ou variâncias entre totais de conglomerados, $Var_{ec_T}$ ou $S^2_{ec}$, necessários para os cálculos de $m$ devem ser **estimados**, por estudos prévios, similares, ou piloto.
