...
Seja $CV = \frac{Var_{ec_T}}{\overline Y_c}$ então na **AASc** de conglomerados

$$m = \frac{z_{\alpha/2} \: CV^2}{e_r^2},$$
e na **AASs** de conglomerados

$$m = \frac{M \: z_{\alpha/2} \: CV^2}{z_{\alpha/2} \: CV^2 + (M-1) \: e_r^2}.$$
