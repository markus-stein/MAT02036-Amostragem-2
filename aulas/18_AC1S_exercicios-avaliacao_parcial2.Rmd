...
a) Para estimar pontualmente a proporção de pneus da frota fora de condições, temos dois possíveis estimadores

$$\widehat P_{AC1S}^{HT} = \frac {\widehat T_{AC1S/HT}}{N} = \frac {M} {N} \frac{1}{m} \sum_{i \in a} T_i = \overline y_C / \overline N$$

ou

$$\widehat P_{AC1S}^R = \frac{\widehat T_{AC1S}^R}{N} = \frac{1}{n} \sum_{i \in a} T_i = \overline y_C / \overline  n = \overline y$$
