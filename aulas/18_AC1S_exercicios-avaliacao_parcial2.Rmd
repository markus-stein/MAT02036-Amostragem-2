...
b) Usando os resultados como um estudo piloto, o número de táxis necessário para obter uma estimativa da proporção de pneus fora das condições, com um erro relativo de $2,5\%$ e $95\%$ de confiança, considerando **AC1s** com reposição, ...
